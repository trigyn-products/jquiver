...
```text
jquiver-ai/reference/script-util-reference.md
```

It should also be linked from:

```text
jquiver-ai/knowledge-base/32-script-library.md
jquiver-ai/knowledge-base/07-dynamic-rest-api.md
jquiver-ai/knowledge-base/08-templates.md
jquiver-ai/skills/jquiver-script-library/SKILL.md
jquiver-ai/skills/jquiver-dynamic-rest/SKILL.md
jquiver-ai/playbooks/configure-script-library.md
```
