...
public class FileUploadConfig {
	...
	public FileUploadConfig(String fileBinId, String fileTypSupported, BigDecimal maxFileSize, Integer noOfFiles, String selectQueryContent,
			String uploadQueryContent, String viewQueryContent, String deleteQueryContent, String datasourceId, Integer isDeleted,
			String createdBy, Date createdDate, String lastUpdatedBy, Date lastUpdatedTs) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(createdBy, datasourceId, deleteQueryContent, fileBinId, fileTypSupported, isDeleted, maxFileSize, noOfFiles,
				selectQueryContent, lastUpdatedBy, uploadQueryContent, viewQueryContent);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(createdBy, other.createdBy) && Objects.equals(datasourceId, other.datasourceId)
				&& Objects.equals(deleteQueryContent, other.deleteQueryContent) && Objects.equals(fileBinId, other.fileBinId)
				&& Objects.equals(fileTypSupported, other.fileTypSupported) && Objects.equals(isDeleted, other.isDeleted)
				&& Objects.equals(maxFileSize, other.maxFileSize) && Objects.equals(noOfFiles, other.noOfFiles)
				&& Objects.equals(selectQueryContent, other.selectQueryContent) && Objects.equals(lastUpdatedBy, other.lastUpdatedBy)
				&& Objects.equals(uploadQueryContent, other.uploadQueryContent) && Objects.equals(viewQueryContent, other.viewQueryContent);
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("FileUploadConfig [fileBinId=").append(fileBinId).append(", fileTypSupported=").append(fileTypSupported)
				.append(", maxFileSize=").append(maxFileSize).append(", noOfFiles=").append(noOfFiles).append(", selectQueryContent=")
				.append(selectQueryContent).append(", uploadQueryContent=").append(uploadQueryContent).append(", viewQueryContent=")
				.append(viewQueryContent).append(", deleteQueryContent=").append(deleteQueryContent).append(", datasourceId=")
				.append(datasourceId).append(", isDeleted=").append(isDeleted).append(", createdBy=").append(createdBy)
				.append(", createdDate=").append(createdDate).append(", lastUpdatedBy=").append(lastUpdatedBy).append(", lastUpdatedTs=")
				.append(lastUpdatedTs).append("]");
