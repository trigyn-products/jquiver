...
public final class QueryStore {
    ...
    public static final String JPA_QUERY_TO_GET_MODULE_BY_MODULE_ID = "SELECT new com.trigyn.jws.menu.vo.ModuleDetailsVO "
    ...
    public static final String JPA_QUERY_TO_GET_ALL_MODULES = "SELECT new com.trigyn.jws.menu.vo.ModuleDetailsVO "
    		+ " (ml.moduleId AS moduleId, COALESCE(mlI18n.moduleName, mlI18nDef.moduleName) AS moduleName ) "
    		+ " FROM ModuleListing AS ml "
    		+ " LEFT OUTER JOIN ml.moduleListingI18ns AS mlI18n ON mlI18n.id.languageId = :languageId "
    		+ " LEFT OUTER JOIN ml.moduleListingI18ns AS mlI18nDef ON mlI18nDef.id.languageId = :defaultLanguageId ";
    
    public static final String JPA_QUERY_TO_GET_ALL_MODULES_DETAILS = "SELECT new com.trigyn.jws.menu.vo.ModuleDetailsVO "
    		+ " (ml.moduleId AS moduleId, COALESCE(mlI18n.moduleName, mlI18nDef.moduleName) AS moduleName "
    ...
    public static final String JPA_QUERY_TO_GET_ALL_MODULE_TARGET_LOOKUP = "SELECT new com.trigyn.jws.menu.vo.ModuleTargetLookupVO "
