    ...
    <div id="errorMessage" class="alert errorsms alert-danger alert-dismissable" style="display:none"></div>
    	...
    	<div class="row">
	    		...
	    		<div class="col-4">
                    <div class="col-inner-form full-form-fields">
					    <span class="asteriskmark">*</span>
						<label for="datasourceid">Datasource Id</label>
                        ...
                        <span onclick="copyId()" style="float: right;margin-right: 6px;margin-top: -20px;position: relative;z-index: 2;">
...
<script>
    ...
    function manageRecord(uiObject) {
        ...
        let actionElement = ''<span id="''+rowIndx+''" onclick="createNew(this)" class= "grid_action_icons" title="<@resourceBundle''jws.edit''/>"><i class="fa fa-pencil"></i></span>''.toString();
