...
public class ModuleVersionDAO extends DBConnection{
	...
	private final static String HQL_QUERY_TO_GET_CHECKSUM_BY_ENTITY_ID_AND_ENTITY_NAME
	= "SELECT jmv.moduleJsonChecksum AS moduleJsonChecksum FROM JwsModuleVersion jmv WHERE jmv.entityId=:entityId AND jmv.entityName=:entityName ORDER BY jmv.versionId DESC ";
