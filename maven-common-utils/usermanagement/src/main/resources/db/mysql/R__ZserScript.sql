...
FROM dashboard AS db ON DUPLICATE KEY UPDATE last_updated_date = NOW();
...
LEFT OUTER JOIN module_listing_i18n AS mli18n ON ml.module_id = mli18n.module_id AND mli18n.language_id = 1 ON DUPLICATE KEY UPDATE last_updated_date = NOW();
...
FROM jws_dynamic_rest_details AS jdrd ON DUPLICATE KEY UPDATE last_updated_date = NOW();
...
INSERT INTO jws_entity_role_association (entity_role_id  ,entity_id  ,entity_name  ,module_id  ,role_id  ,last_updated_date  ,last_updated_by  ,is_active
  ...
  ,'b4a0dda1-097f-11eb-9a16-f48e38ab9348' AS role_id ,now()  AS last_updated_date ,'aar.dev@trigyn.com' AS last_updated_by ,1 AS is_active             
FROM autocomplete_details as ad ON DUPLICATE KEY UPDATE last_updated_date = NOW();
...
INSERT INTO jws_entity_role_association (
  ...
  ,1 AS is_active              
FROM grid_details gd ON DUPLICATE KEY UPDATE last_updated_date = NOW();
INSERT INTO jws_entity_role_association (
   entity_role_id
  ,entity_id
  ,entity_name
...
INSERT INTO jws_entity_role_association (
  ...
  ,'admin' AS last_updated_by        
  ,1 AS is_active              
FROM template_master tm ON DUPLICATE KEY UPDATE last_updated_date = NOW();
INSERT INTO jws_entity_role_association (
   entity_role_id
  ,entity_id
  ,entity_name
...
INSERT INTO jws_entity_role_association (
  ...
  ,'admin' AS last_updated_by        
  ,1 AS is_active              
FROM dynamic_form df ON DUPLICATE KEY UPDATE last_updated_date = NOW();
INSERT INTO jws_entity_role_association (
   entity_role_id
  ,entity_id
  ,entity_name
...
INSERT INTO jws_entity_role_association (
  ...
  ,'admin' AS last_updated_by        
  ,1 AS is_active              
FROM module_listing ml INNER JOIN module_listing_i18n ml_i18n ON ml.module_id = ml_i18n.module_id AND ml_i18n.language_id=1 ON DUPLICATE KEY UPDATE last_updated_date = NOW();
INSERT INTO jws_entity_role_association (
   entity_role_id
  ,entity_id
  ,entity_name
