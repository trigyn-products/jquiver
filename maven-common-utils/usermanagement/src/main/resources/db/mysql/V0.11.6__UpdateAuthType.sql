...
UPDATE  jws_user SET secret_key = "XJZI7XO2YD2PEZJQU3RLS4TBDTPL47AJ",registered_by=2  WHERE user_id="111415ae-0980-11eb-9a16-f48e38ab9348"; 

UPDATE jws_authentication_type SET authentication_properties ='[{"name":"google","type":"select","selected":false,"client-id":"95167754409-2vlhnv114r2o59hhrier3gpq1ftr1nu9.apps.googleusercontent.com","client-secret":"6Tx6P3oYKDeAGZiSn2Ht9jUh","value":0},
