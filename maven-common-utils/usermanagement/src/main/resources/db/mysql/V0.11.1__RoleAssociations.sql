...
REPLACE INTO jws_entity_role_association (entity_role_id,entity_id,entity_name,module_id,role_id,last_updated_date,last_updated_by,is_active)
...
REPLACE INTO jws_entity_role_association (
   entity_role_id
  ,entity_id
  ,entity_name
  ,module_id
