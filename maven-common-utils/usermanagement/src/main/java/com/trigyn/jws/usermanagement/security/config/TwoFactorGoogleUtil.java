...
//		//System.out.println(getGoogleAuthenticatorBarCode("a.d.chowdhury@gmail.com", "My Company"));
//		//createQRCode(getGoogleAuthenticatorBarCode("ravi.gowda@trigyn.com", "Trigyn"), "D://" + UUID.randomUUID().toString() + ".png", 300, 300);
//		validateOTP();
//	}
