DROP TABLE IF EXISTS jq_context_master;
CREATE TABLE jq_context_master (
...
CREATE TABLE jq_dashboard_dashlet_association (
  ...
  KEY jq_dashboard_dashlet_association_ibfk_1 (dashboard_id),
...
CREATE TABLE jq_dashboard_shared_to_association (
...
CREATE TABLE jq_dashlet_property_configuration (
  ...
  KEY jq_dashlet_property_configuration_ibfk_1 (property_id),
...
, KEY jq_dashlet_role_association_ibfk_1 (dashlet_id)
...
ALTER TABLE jq_dashlet ADD UNIQUE INDEX (dashlet_name);

INSERT INTO jq_context_master(context_id ,context_description  ,allow_dashboard_addition  ,created_by  ,created_date) VALUES ('a0bb79ce-eadd-11ea-a036-e454e805e22f', 'jws'  ,0  ,'admin'  ,NOW());

INSERT into jq_dashboard (dashboard_id, dashboard_name, context_id, dashboard_type, created_by, created_date, last_updated_date, is_deleted, is_draggable, is_exportable) VALUES
('ab7202bf-eadd-11ea-a036-e454e805e22f', 'Java Stater Usages', (SELECT context_id FROM jq_context_master where context_description='jws'), '1', 'admin', NOW(), NOW(), 0, 1, 0);

INSERT INTO jq_dashlet (dashlet_id, dashlet_title, dashlet_name, dashlet_body, dashlet_query, is_active, created_by, created_date, updated_by, updated_date, x_coordinate, y_coordinate, dashlet_width, dashlet_height, context_id, show_header,dashlet_query_checksum,dashlet_body_checksum) VALUES
('09b78b43-eade-11ea-a036-e454e805e22f', 'Grids', 'Grids', '<div>Total of <#list resultSet as queryOutput>${queryOutput.gridCount}</#list> used in application</div>', 'SELECT COUNT(gd.grid_id) AS gridCount FROM jq_grid_details AS gd', 1, 'admin', NOW(), 'admin', NOW(), 0, 0, 6, 3, 'a0bb79ce-eadd-11ea-a036-e454e805e22f', 1,null,null), 
...
('31c9ffa9-eadf-11ea-a036-e454e805e22f', 'Templates', 'Templates', '<div>Total of <#list resultSet as queryOutput>${queryOutput.templateCount}</#list> used in application</div>', 'SELECT COUNT(tm.template_id) AS templateCount FROM jq_template_master AS tm', 1, 'admin', NOW(), 'admin', NOW(), 6, 3, 6, 3, 'a0bb79ce-eadd-11ea-a036-e454e805e22f', 1,null,null), 
('37dbbc8d-eadf-11ea-a036-e454e805e22f', 'DB resource bundles', 'DB resource bundles', '<div>Total of <#list resultSet as queryOutput>${queryOutput.resourceBundleCount}</#list> used in application</div>', 'SELECT COUNT(DISTINCT(rb.resource_key)) AS resourceBundleCount FROM jq_resource_bundle AS rb', 1, 'admin', NOW(), 'admin', NOW(), 0, 6, 6, 3, 'a0bb79ce-eadd-11ea-a036-e454e805e22f', 1,null,null), 
('3d97273b-eadf-11ea-a036-e454e805e22f', 'Dashboards', 'Dashboards', '<div>Total of <#list resultSet as queryOutput>${queryOutput.dashboardCount}</#list> used in application</div>', 'SELECT COUNT(db.dashboard_id) AS dashboardCount FROM  jq_dashboard AS db', 1, 'admin', NOW(), 'admin', NOW(), 6, 3, 6, 3, 'a0bb79ce-eadd-11ea-a036-e454e805e22f', 1,null,null),
...
INSERT INTO jq_dashboard_dashlet_association (dashboard_id, dashlet_id) VALUES ('ab7202bf-eadd-11ea-a036-e454e805e22f','09b78b43-eade-11ea-a036-e454e805e22f');
INSERT INTO jq_dashboard_dashlet_association (dashboard_id, dashlet_id) VALUES ('ab7202bf-eadd-11ea-a036-e454e805e22f','0eb8adc4-eade-11ea-a036-e454e805e22f');
INSERT INTO jq_dashboard_dashlet_association (dashboard_id, dashlet_id) VALUES ('ab7202bf-eadd-11ea-a036-e454e805e22f','31c9ffa9-eadf-11ea-a036-e454e805e22f');
INSERT INTO jq_dashboard_dashlet_association (dashboard_id, dashlet_id) VALUES ('ab7202bf-eadd-11ea-a036-e454e805e22f','37dbbc8d-eadf-11ea-a036-e454e805e22f');
INSERT INTO jq_dashboard_dashlet_association (dashboard_id, dashlet_id) VALUES ('ab7202bf-eadd-11ea-a036-e454e805e22f','3d97273b-eadf-11ea-a036-e454e805e22f');
INSERT INTO jq_dashboard_dashlet_association (dashboard_id, dashlet_id) VALUES ('ab7202bf-eadd-11ea-a036-e454e805e22f','44cb330d-eadf-11ea-a036-e454e805e22f');

INSERT INTO jq_dashlet_role_association (dashlet_id, role_id) VALUES ('09b78b43-eade-11ea-a036-e454e805e22f', 'ab751695-fcb9-11ea-954a-f48e38ab8cd7');
INSERT INTO jq_dashlet_role_association (dashlet_id, role_id) VALUES ('0eb8adc4-eade-11ea-a036-e454e805e22f', 'ab751695-fcb9-11ea-954a-f48e38ab8cd7');
INSERT INTO jq_dashlet_role_association (dashlet_id, role_id) VALUES ('31c9ffa9-eadf-11ea-a036-e454e805e22f', 'ab751695-fcb9-11ea-954a-f48e38ab8cd7');
INSERT INTO jq_dashlet_role_association (dashlet_id, role_id) VALUES ('37dbbc8d-eadf-11ea-a036-e454e805e22f', 'ab751695-fcb9-11ea-954a-f48e38ab8cd7');
INSERT INTO jq_dashlet_role_association (dashlet_id, role_id) VALUES ('3d97273b-eadf-11ea-a036-e454e805e22f', 'ab751695-fcb9-11ea-954a-f48e38ab8cd7');
INSERT INTO jq_dashlet_role_association (dashlet_id, role_id) VALUES ('44cb330d-eadf-11ea-a036-e454e805e22f', 'ab751695-fcb9-11ea-954a-f48e38ab8cd7');

INSERT INTO jq_dashboard_lookup_category (lookup_category_id, lookup_category, lookup_description, updated_by, updated_date) VALUES
