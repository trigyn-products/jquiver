...
public final class QueryStore {
    ...
    protected static final String JPA_QUERY_TO_GET_TEMPALTE_DETAILS = "SELECT new com.trigyn.jws.templating.vo.TemplateVO(tm.templateId, tm.templateName, tm.template) FROM TemplateMaster as tm "
    ...
    protected static final String JPA_QUERY_TO_GET_ALL_DEFAULT_TEMPLATES = " SELECT new com.trigyn.jws.templating.vo.TemplateVO(tm.templateId, tm.templateName, tm.template, tm.checksum, tm.templateTypeId)"
    		+ " FROM TemplateMaster as tm "
    		+ " WHERE tm.templateTypeId = :defaultTemplateTypeId ";
}