...
public final class QueryStore {
	...
	public static final String		JPA_QUERY_TO_GET_FILE_TEMP_DETAILS_BY_FILE_BIN_ID_ILE_TEMP_ASSOC_ID		= "SELECT fut FROM FileUploadTemp AS fut WHERE fut.fileAssociationId = :fileAssociationId AND fut.fileBinId = :fileBinId AND fut.fileUploadId = :fileUploadId AND fut.action = -1";
}