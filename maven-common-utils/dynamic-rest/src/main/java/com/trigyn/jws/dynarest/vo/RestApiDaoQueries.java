...
public class RestApiDaoQueries {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(jwsDaoQueryTemplate, restApiDaoQueries.jwsDaoQueryTemplate) && Objects.equals(jwsResultVariableName, restApiDaoQueries.jwsResultVariableName) && Objects.equals(jwsQuerySequence, restApiDaoQueries.jwsQuerySequence);
    }
    ...
    public String toString() {
        return "{" +
            " jwsDaoQueryTemplate='" + getJwsDaoQueryTemplate() + "'" +
            ", jwsResultVariableName='" + getJwsResultVariableName() + "'" +
