...
@Component
public class TemplateExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(TemplateExportableData.class);
	...
	public List<Object> generateDynamicModuleQuery(List<String> systemConfigIncludeList,
		...
		if (autoExport) {
			StringBuilder querySQL = new StringBuilder(
					CrudQueryStore.HQL_QUERY_TO_FETCH_TEMPLATE_DATA_FOR_AUTO_EXPORT);
			if (modifiedAfter != null) {
			 ...
			 if (name != null) {
			    ...
			    if (entityType != null) {
					...
					querySQL.append(" tm.template_type_id = :entityType ");
				}
			BeanPropertyRowMapper<TemplateMaster> mapper = new BeanPropertyRowMapper<TemplateMaster>(TemplateMaster.class);
