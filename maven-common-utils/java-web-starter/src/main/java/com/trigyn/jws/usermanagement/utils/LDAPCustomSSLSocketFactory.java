 ...
 *
 */
public class LDAPCustomSSLSocketFactory extends SSLSocketFactory {
    private SSLSocketFactory socketFactory;

    public LDAPCustomSSLSocketFactory() {
        try {
    ...
    public static SocketFactory getDefault() {
        return new LDAPCustomSSLSocketFactory();
    }
    ...
    /**
           * Betvasive certificate verification
     */
