...
public class HelManualEntityValidator implements EntityValidator {
	...
	private final static Logger					logger							= LoggerFactory.getLogger(HelManualEntityValidator.class);
	...
	public String getEntityName(HttpServletRequest reqObject, List<String> roleNameList, ProceedingJoinPoint a_joinPoint) {
		...
		return entityRoleAssociationDAO.getEntityNameByEntityAndRoleId(Constants.Modules.HELPMANUAL.getModuleName(), manualName);
	}
