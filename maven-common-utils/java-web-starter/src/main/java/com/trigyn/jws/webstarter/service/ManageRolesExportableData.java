...
@Component
public class ManageRolesExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(ManageRolesExportableData.class);
