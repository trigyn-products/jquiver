...
@Component
public class AppConfigExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(AppConfigExportableData.class);
	...
	public List<Object> generateDynamicModuleQuery(List<String> systemConfigIncludeList,
		...
		if (autoExport) {
			StringBuilder querySQL = new StringBuilder(
					CrudQueryStore.HQL_QUERY_TO_FETCH_APP_CONFIG_DATA_FOR_AUTO_EXPORT);
			if (modifiedAfter != null) {
				...
				querySQL.append("pm.last_modified_date  >=:modifiedAfter ");
