...
@Component
public class SchedulerExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(SchedulerExportableData.class);
	...
	public List<Object> generateDynamicModuleQuery(List<String> systemConfigIncludeList,
		...
		if (autoExport) {
			StringBuilder querySQL = new StringBuilder(
					CrudQueryStore.HQL_QUERY_TO_FETCH_SCHEDULER_DATA_FOR_AUTO_EXPORT);
			if (modifiedAfter != null) {
				...
				querySQL.append("js.last_modified_date >=:modifiedAfter ");
			}
			...
			if (entityType != null) {
				...
				querySQL.append(" js.scheduler_type_id = :entityType ");
			}
			BeanPropertyRowMapper<JqScheduler> mapper = new BeanPropertyRowMapper<JqScheduler>(JqScheduler.class);
