...
@Component
public class ScriptLibraryExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(ScriptLibraryExportableData.class);
	...
	public List<Object> generateDynamicModuleQuery(List<String> systemConfigIncludeList, List<String> customConfigExcludeList,
		...
		if (autoExport) {
			StringBuilder querySQL = new StringBuilder(
					CrudQueryStore.HQL_QUERY_TO_FETCH_SCRIPT_LIBRARY_DATA_FOR_AUTO_EXPORT);
			if (modifiedAfter != null) {
				...
				querySQL.append("sl.updated_date >=:modifiedAfter ");
