...
public interface JwsUserRoleAssociationRepository extends JpaRepository<JwsUserRoleAssociation, String> {
	...
	List<JwsUserRoleAssociation> findByUserId(@Param("userId") String userId);
	...
	List<JwsRoleModuleAssociationVO> getRoleModuleAssociation(@Param("isActive") Integer isActive, @Param("userId") String userId);
	...
	List<JwsRoleVO> getUserRoles(@Param("isActive") Integer isActive, @Param("userId") String userId);
}
