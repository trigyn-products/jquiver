...
public class FileUploadTemp {
	...
	public FileUploadTemp(String fileUploadTempId, String fileUploadId, String physicalFileName,
			String originalFileName, String filePath, String updatedBy, String fileBinId, String fileAssociationId,
			Integer action) {
		this.fileUploadTempId	= fileUploadTempId;
	...
	public String getFileUploadTempId() {
		return fileUploadTempId;
	}

	public void setFileUploadTempId(String fileUploadTempId) {
		this.fileUploadTempId = fileUploadTempId;
	}
	...
	public boolean equals(Object obj) {
		...
		FileUploadTemp other = (FileUploadTemp) obj;
