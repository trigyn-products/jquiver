...
@Component
public class FileManagerExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(FileManagerExportableData.class);
	...
	public List<Object> generateDynamicModuleQuery(List<String> systemConfigIncludeList,
		...
		if (autoExport) {
			StringBuilder querySQL = new StringBuilder(
					CrudQueryStore.HQL_QUERY_TO_FETCH_FILE_MANAGER_DATA_FOR_AUTO_EXPORT);
