...
@Component
public class ApiClientExportableData implements GenerateModuleMasterQueries {

	private final static Logger logger = LoggerFactory.getLogger(ApiClientExportableData.class);
	...
	public List<Object> generateDynamicModuleQuery(List<String> systemConfigIncludeList,
		...
		if (autoExport) {
			StringBuilder querySQL = new StringBuilder(
					CrudQueryStore.HQL_QUERY_TO_FETCH_API_CLIENT_DETAILS_FOR_AUTO_EXPORT);
			...
			exportableList = importExportCrudDAO.getAllExportableData(
					CrudQueryStore.HQL_QUERY_TO_FETCH_API_CLIENT_DETAILS_FOR_EXPORT, null, null,
