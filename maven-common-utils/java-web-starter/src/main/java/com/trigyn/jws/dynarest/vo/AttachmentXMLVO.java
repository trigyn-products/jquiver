...
public class AttachmentXMLVO {
	...
	public boolean equals(Object obj) {
		...
		AttachmentXMLVO other = (AttachmentXMLVO) obj;
		return Objects.equals(fileName, other.fileName) && Objects.equals(filePath, other.filePath) && Objects.equals(type, other.type);
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("AttachmentXMLVO [type=").append(type).append(", fileName=").append(fileName).append(", filePath=").append(filePath)
				.append("]");
