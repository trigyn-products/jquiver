...
<script>
	...
	$(function () {
	    ...
	    let colM = [
	        ...
	        filter: { type: "textbox", condition: "contain", listeners: ["change"]} },
	        { title: "${messageSource.getMessage(''jws.action'')}", width: 50, minWidth: 115, dataIndx: "action", align: "center", halign: "center", render: editFileUploadConfig, sortable: false}
	    ];
		let dataModel = {
...
, fuc.delete_query_content AS deleteQueryContent, fuc.updated_by AS updatedBy
  ...
  <form method="post" name="addEditForm" id="addEditForm">
    	<div id="errorMessage" class="alert errorsms alert-danger alert-dismissable" style="display:none"></div>
			...
			<div class="col-inner-form full-form-fields">
				...
				<input type="text" id="fileBinId" name="fileBinId"  value="" maxlength="500" class="form-control">
			</div>
		</div>
    		<div class="col-3">
			<div class="col-inner-form full-form-fields">
...
<#else>
    INSERT INTO jq_file_upload_config (file_bin_id, file_type_supported, max_file_size, no_of_files, select_query_content, upload_query_content, view_query_content, delete_query_content, is_deleted, updated_by, updated_date) 
...
('74f78214-3add-4e18-84d6-fb3b76805556', 'fum', NULL, 5, '7df80a38-7740-11eb-94ed-f48e38ab8cd7', NULL, 0, 0);
...
REPLACE INTO jq_file_upload_config (file_bin_id, file_type_supported, max_file_size, no_of_files, select_query_content, upload_query_content, view_query_content, delete_query_content, is_deleted, updated_by, updated_date) VALUES
('default', '', 32000000, 50, 
...
(jws_dynamic_rest_id, jws_dynamic_rest_url, jws_rbac_id, jws_method_name, jws_method_description, jws_request_type_id, jws_response_producer_type_id, jws_service_logic, jws_platform_id, jws_allow_files, jws_dynamic_rest_type_id) VALUES
...
getFileBinQueries(requestDetails, daoResults);', 3, 0, 2);
