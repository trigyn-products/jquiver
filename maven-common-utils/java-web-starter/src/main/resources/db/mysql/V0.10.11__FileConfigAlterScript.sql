ALTER TABLE jq_file_upload_config
 CHANGE file_upload_config_id file_bin_id VARCHAR(100) NOT NULL;
 
ALTER TABLE jq_file_upload
 CHANGE file_config_id file_bin_id VARCHAR(100) NOT NULL AFTER file_upload_id,
...
ALTER TABLE jq_file_upload_config
 ...
 CHANGE updated_by updated_by VARCHAR(100) NOT NULL,
