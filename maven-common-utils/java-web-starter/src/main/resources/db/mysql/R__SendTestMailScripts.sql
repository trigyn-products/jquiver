...
Replace into dynamic_form 
(form_id, form_name, form_description, form_select_query, form_body, created_by, created_date, form_select_checksum, form_body_checksum) VALUES
('193d770c-1217-11eb-980f-802bf9ae2eda', 'mail-configuration-form', 'Mail configuration form', 'select * from jws_property_master where property_name = "mail-configuration"', '<head>
...
saveMailConfigDetailsJson=JSON.stringify(jsonobject);
 	...
 	$.ajax({
      ...
      saveMailConfigDetailsJson :saveMailConfigDetailsJson
          ...
          if(data){
          showMessage("Test Mail sent  successfully", "success");
          }else{
...
('a3caf8fd-1aa8-11eb-a009-e454e805e22f', 'mailConfirationDetails', 1, 'saveMailConfigDetails', 'Get mail json details', 1, 7, '', 1);
