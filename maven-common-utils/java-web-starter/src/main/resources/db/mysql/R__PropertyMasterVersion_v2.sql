...
VALUES ('e887b756-1a8f-11eb-98d3-f48e38ab1234','system', 'system', 'version', 'JQuiver 2.13', 0, NOW(), 'admin', 1.00, 'Application version');

UPDATE jq_user SET email = "admin@localhost.io", force_password_change = 1 WHERE email="admin@trigyn.com";
