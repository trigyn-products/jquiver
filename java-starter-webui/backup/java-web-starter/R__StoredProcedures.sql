...
'autocompleteId,autocompleteDescription,lastUpdatedBy,lastUpdatedTs,autocompleteTypeId,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());


REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("dashboardMasterListingGrid", 'Dashboard Master Listing', 'Dashboard Master', 'dashboardMasterListing'
,'dashboardName,dashboardType,contextDescription,createdDate,createdBy,lastUpdatedTs,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());

REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("dashletMasterListingGrid", 'Dashlet Master Listing', 'Dashlet Master', 'dashletMasterListing'
,'dashletName,dashletTitle,dashletTypeId,createdDate,createdBy,lastUpdatedTs,updatedBy,status,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());

REPLACE INTO jq_grid_details (grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts)
VALUES ("dynamicFormListingGrid", 'Dynamic Form Master', 'Dynamic Form Master Listing', 'dynamicFormListing'
,'formId,formName,formDescription,formTypeId,createdDate,createdBy,lastUpdatedBy, lastUpdatedTs,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());
...
,'targetPlatform,messageType,validFrom,messageText,validTill,messageFormat,selectionCriteria,updatedBy,updatedDate,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());

REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts)
VALUES ("moduleListingGrid", 'Menu Module Listing', 'Menu Module Listing', 'moduleListing'
,'moduleId,moduleName,moduleURL,parentModuleName,sequence,isInsideMenu,moduleTypeId,lastUpdatedTs,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());
...
,'jws_dynamic_rest_id,jws_dynamic_rest_url,jws_method_name,jws_method_description,jws_request_type_id,jws_platform_id,jws_dynamic_rest_type_id,last_updated_by,last_updated_ts', 1, 2, 'aar.dev@jquiver.io', NOW(), NOW());

REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, query_type, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("propertyMasterListing", 'Property master listing', 'Property master listing', 'jq_property_master','*', 1, 2, 'aar.dev@jquiver.io', NOW(), NOW());

REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("fileUploadConfigGrid", 'File Upload Config', 'File Upload Config', 'fileUploadConfigListing'
,'fileBinId,fileTypeSupported,maxFileSize,noOfFiles,lastUpdatedBy, lastUpdatedTs,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());

REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("propertyMasterListingGrid", 'Property Master Listing', 'Property Master Listing', 'propertyMasterListing'
,'ownerType,ownerId,propertyName,propertyValue,modifiedBy,appVersion,comments,lastModifiedDate,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW());
 
REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("dynarestListingGrid", 'Dynamic REST API Listing', 'Dynamic REST API Listing', 'dynarestListing'
,'dynarestUrl,rbacId,methodName,methodDescription,requestTypeId,producerTypeId,serviceLogic,platformId,allowFiles,dynarestTypeId,lastUpdatedBy,lastUpdatedTs,isAfterDate', 2, 'aar.dev@jquiver.io', NOW(), NOW()); 

REPLACE INTO jq_grid_details(grid_id, grid_name, grid_description, grid_table_name, grid_column_names, grid_type_id, created_by, created_date, last_updated_ts) 
VALUES ("jq_api_client_details_grid", 'API Clients Grid', 'API Clients Grid', 'apiClientDetails'
,'client_id,client_name,client_key,client_secret,encryption_algo_id,updated_by,created_by,updated_date,encryption_algo_name,isAfterDate', 2, 'admin@jquiver.io', NOW(), NOW()); 
...
CREATE PROCEDURE notificationlisting(targetPlatform VARCHAR(100), messageType VARCHAR(500), validFrom VARCHAR(500), messageText VARCHAR(500), validTill VARCHAR(100), messageFormat VARCHAR(100), selectionCriteria VARCHAR(500), updatedBy VARCHAR(100), updatedDate VARCHAR(100), isAfterDate VARCHAR(50), forCount INT, limitFrom INT, limitTo INT,sortIndex VARCHAR(100),sortOrder VARCHAR(20))
BEGIN
DECLARE db_format VARCHAR(20);
...
BEGIN
  ...
  SET @resultQuery = ' SELECT ml.module_id AS moduleId,COALESCE(mli18n.module_name,mli18n2.module_name) AS moduleName, ml.module_url AS moduleURL, 
    ...
    ', ml.sequence AS sequence, ml.is_inside_menu AS isInsideMenu, ml.is_home_page AS isHomePage, ml.module_type_id AS moduleTypeId, ml.last_modified_date AS lastUpdatedTs ';
