    ...
    <div class="cm-card-body">
     ...
     <div class="upload" id="parentUpload">
    	<div class="upload-box" id="uploadBox">
         ...
         <div id="divImportFromLocal" style="display: none;">
                <input id="btnImportFromLocal" class="btn btn-primary" name="btnImportFromLocal"
			    value="Import From Local" type="button" onclick="importFromLocal()">
            </div>    
     </div>
...
<script>
	...
	$(function(){
        ...
        if(profile=="dev") {
            $("#divImportFromLocal").show();
        } else {
            $("#divImportFromLocal").hide();  
        }
...
<div class="container">
	...
	<div class="topband cm-card-header">
        ...
        <div class="float-right">
            <div id="expHeader">
                ...
                <span>
                Modified After: <input type="checkbox" id="chkDatePicker" onchange="selectAsperDate()">
                    <input id="modifiedAfter" data-type="varchar" name="modifiedAfter" placeholder="Modified After" autocomplete="off"/>
                    <button id="modifiedAfter-trigger" class="calender_icon"><i class="fa fa-calendar" aria-hidden="true"></i></button>
                </span>
            </div>
    ...
    <div class="cm-card-footer"><div class="clearfix"></div>
		...
		<div id="nextTabBtn" style="display: none;">
            <div id="divExportToLocal" style="display: none;">
                <input id="btnExportToLocal" class="btn btn-primary" style="float: right;" name="btnExportToLocal"
			    value="Export to Local" type="button" onclick="exportToLocal()">
            </div>
